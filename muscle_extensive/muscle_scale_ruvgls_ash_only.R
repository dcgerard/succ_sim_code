...
sruvash_betahat   <- sout[1, ]
sruvash_lfdr      <- sout[2, ]
sruvash_pi0hat    <- sout[3, ]

save(sruvash_betahat, file = "betahat_muscle_sruvash.Rd")
save(sruvash_lfdr, file = "lfdr_muscle_sruvash.Rd")
save(sruvash_pi0hat, file = "pi0hat_muscle_sruvash.Rd")
