...
ruvash_lim_betahat   <- sout[1, ]
ruvash_lim_lfdr      <- sout[2, ]
ruvash_lim_pi0hat    <- sout[3, ]
ruvash_lim_scale     <- sout[4, ]
ruvash_lim_numsv     <- sout[5, ]

save(ruvash_lim_betahat, file = "betahat_muscle_ruvash.Rd")
save(ruvash_lim_lfdr, file = "lfdr_muscle_ruvash.Rd")
save(ruvash_lim_pi0hat, file = "pi0hat_muscle_ruvash.Rd")
save(ruvash_lim_scale, file = "scale_muscle_ruvash.Rd")
save(ruvash_lim_numsv, file = "numsv_muscle_ruvash.Rd")
