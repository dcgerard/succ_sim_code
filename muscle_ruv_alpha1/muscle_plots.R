...
pi0_ruvash_alpha1 <- read.csv("pi0_ruvash_alpha1.csv")
mse_ruvash_alpha1 <- read.csv("mse_ruvash_alpha1.csv")
auc_ruvash_alpha1 <- read.csv("auc_ruvash_alpha1.csv")

pi0_mat <- cbind(pi0_mat, pi0_ruvash_alpha1[, -(1:4)])
mse_mat <- cbind(mse_mat, mse_ruvash_alpha1[, -(1:4)])
auc_mat <- cbind(auc_mat, auc_ruvash_alpha1[, -(1:4)])
auc_mat <- auc_mat[auc_mat$nullpi != 1, ]

pdf(file = "muscle_tissue_alpha1.pdf")
## pi0_plot
