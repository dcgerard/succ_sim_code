...
pi0_mat$pi0hat_ruv_asht <- ruv_asht_df$pi0hat
mse_mat$mse_ruv_asht <- ruv_asht_df$mse
auc_mat$auc_ruv_asht <- ruv_asht_df$auc[ruv_asht_df$nullpi != 1]



pdf(file = "muscle_tissue_ruv_asht.pdf")
## pi0_plot
